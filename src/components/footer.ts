...
<footer class="mt-auto w-full py-8 sm:py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-gradient-to-r from-slate-800 via-slate-900 to-gray-900 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
  ...
  <div class="text-center">
    ...
    <div class="mt-4 sm:mt-6 flex flex-wrap justify-center gap-2 sm:gap-3">
      ...
      <!-- X (Twitter) -->
      <a class="w-10 h-10 sm:size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-400 hover:bg-gradient-to-r hover:from-blue-800/50 hover:to-purple-800/50 dark:hover:from-blue-700/50 dark:hover:to-purple-700/50 focus:outline-hidden focus:bg-gradient-to-r focus:from-blue-800/50 focus:to-purple-800/50 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 transition-all duration-200" href="#" aria-label="Twitter">
        <svg class="shrink-0 w-4 h-4 sm:size-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
        </svg>
      </a>
      <!-- Facebook -->
      <a class="w-10 h-10 sm:size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-400 hover:bg-gradient-to-r hover:from-purple-800/50 hover:to-pink-800/50 dark:hover:from-purple-700/50 dark:hover:to-pink-700/50 focus:outline-hidden focus:bg-gradient-to-r focus:from-purple-800/50 focus:to-pink-800/50 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 transition-all duration-200" href="#" aria-label="Facebook">
        <svg class="shrink-0 w-4 h-4 sm:size-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
        </svg>
      </a>
      <!-- Steam -->
      <a class="w-10 h-10 sm:size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-400 hover:bg-gradient-to-r hover:from-emerald-800/50 hover:to-teal-800/50 dark:hover:from-emerald-700/50 dark:hover:to-teal-700/50 focus:outline-hidden focus:bg-gradient-to-r focus:from-emerald-800/50 focus:to-teal-800/50 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 transition-all duration-200" href="#" aria-label="Steam">
        <svg class="shrink-0 w-4 h-4 sm:size-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
